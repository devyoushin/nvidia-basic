...
# docs/03-cuda/cuda-driver-compatibility.md 참조
```

> **예방책**: 업그레이드 전 `docs/03-cuda/cuda-driver-compatibility.md` 호환성 매트릭스 확인
...
- 연관 내부 문서: `docs/01-driver/nvidia-driver-install-al2023.md`, `docs/03-cuda/cuda-driver-compatibility.md`
