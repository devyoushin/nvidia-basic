...
**관련 문서**
- [DCGM Field Identifiers](https://docs.nvidia.com/datacenter/dcgm/latest/user-guide/feature-overview.html#field-identifiers)
- 연관 내부 문서: `docs/dcgm/dcgm-setup.md`, `docs/monitoring/dcgm-exporter-prometheus.md`
