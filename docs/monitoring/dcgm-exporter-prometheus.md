...
A: 불필요. CloudWatch 환경에서는 `docs/monitoring/cw-gpu-metrics.md`의 CWAgent + DCGM 방식 사용.
      ...
      rules:
        - alert: GPUXidError
          ...
          annotations:
            ...
            description: "Xid 코드: {{ $value }} — docs/troubleshooting/xid-error-codes.md 참조"
...
- 연관 내부 문서: `docs/dcgm/dcgm-setup.md`, `docs/cuda/nvidia-container-toolkit.md`
