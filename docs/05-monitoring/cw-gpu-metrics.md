...
**관련 문서**
- [CloudWatch Agent nvidia_gpu 설정](https://docs.aws.amazon.com/AmazonCloudWatch/latest/05-monitoring/CloudWatch-Agent-NVIDIA-GPU.html)
- 연관 내부 문서: `docs/02-nvidia-smi/nvidia-smi-query.md`, `docs/04-dcgm/dcgm-setup.md`
