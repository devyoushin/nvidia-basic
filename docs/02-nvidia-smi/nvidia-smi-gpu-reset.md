...
A: 소프트웨어 리셋으로 해결 안 되는 하드웨어 결함. `docs/06-troubleshooting/aws-host-replacement.md` 참조하여 Stop&Start 수행.
...
- 연관 내부 문서: `docs/06-troubleshooting/xid-error-codes.md`, `docs/06-troubleshooting/aws-host-replacement.md`
