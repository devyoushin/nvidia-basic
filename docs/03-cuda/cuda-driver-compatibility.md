...
# 환경 변수 설정
cat >> ~/.bashrc <<'EOF'
export PATH=/usr/local/03-cuda/bin:$PATH
export LD_LIBRARY_PATH=/usr/local/03-cuda/lib64:$LD_LIBRARY_PATH
EOF
source ~/.bashrc
...
- 연관 내부 문서: `docs/01-driver/nvidia-driver-version-management.md`
