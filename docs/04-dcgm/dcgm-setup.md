...
A: `docs/04-dcgm/dcgm-field-groups.md` 또는 `dcgmi dmon --list` 명령으로 지원 필드 목록 확인.
...
- EKS GPU 노드에서는 DCGM Exporter 컨테이너로 배포하는 것이 표준 패턴 (`docs/05-monitoring/dcgm-exporter-prometheus.md` 참조)

**관련 문서**
- [NVIDIA DCGM Documentation](https://docs.nvidia.com/datacenter/04-dcgm/latest/user-guide/index.html)
- 연관 내부 문서: `docs/04-dcgm/dcgm-field-groups.md`, `docs/05-monitoring/cw-gpu-metrics.md`
